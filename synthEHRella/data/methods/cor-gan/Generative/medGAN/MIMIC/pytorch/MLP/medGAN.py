...
parser.add_argument("--num_fake_samples", type=int, default=50000, help="Number of fake samples")
...
if opt.generate:
    ...
    # Loading the checkpoint
    checkpoint = torch.load(os.path.join(opt.PATH, f"model_epoch_{opt.n_epochs}.pth"))
    ...
    num_fake_samples = opt.num_fake_samples
