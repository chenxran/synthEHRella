...
def preprocessing_mimic4(
    ...
    pickle.dump(pids, open(outFile+'_include_icd10.pids', 'wb'), -1)
    pickle.dump(matrix, open(outFile+'_include_icd10.matrix', 'wb'), -1)
    pickle.dump(types, open(outFile+'_include_icd10.types', 'wb'), -1)
