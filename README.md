...
|       | Citation     |
| -------------  | -------------  | 
| systematic review paper | Chen X, Wu Z*, Xu Shi, Hyunghoon Cho, Mukherjee B $^\dagger$ (2024+). Generating Synthetic Electronic Health Record (EHR) Data: A Systematic Review and Benchmarking. [*: correspdonding author (zhenkewu@umich.edu); $^\dagger$: senior author (bhramar.mukherjee@yale.edu)].      |
